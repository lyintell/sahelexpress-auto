...
function normalizeVehicle(vehicle) {
  ...
  return {
    ...
    prix_vente: toNullableNumber(vehicle?.prix_vente),
    prix_achat: toNullableNumber(vehicle?.prix_achat),
    montant_transport: toNullableNumber(vehicle?.montant_transport),
    montant_dedouanement: toNullableNumber(vehicle?.montant_dedouanement),
...
function buildVehiclePayload(nextItem, mode) {
  ...
  return {
    ...
    prix_vente: nextItem?.prix_vente === "" ? null : toNullableNumber(nextItem?.prix_vente),
    prix_achat: nextItem?.prix_achat === "" ? null : toNullableNumber(nextItem?.prix_achat),
    montant_transport: nextItem?.montant_transport === "" ? null : toNullableNumber(nextItem?.montant_transport),
    montant_dedouanement: nextItem?.montant_dedouanement === "" ? null : toNullableNumber(nextItem?.montant_dedouanement),
